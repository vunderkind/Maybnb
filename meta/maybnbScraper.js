    ...
    function webScraper () {
        return new Promise(async (resolve, reject) =>{
            try {
                ...
                await page.goto(`https://www.airbnb.com/s/USA/homes?tab_id=all_tab&refinement_paths%5B%5D=%2Fhomes&source=structured_search_input_header&search_type=search_query`);
